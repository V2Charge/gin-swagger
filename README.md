...
[![Build Status](https://github.com/V2Charge/gin-swagger/actions/workflows/ci.yml/badge.svg?branch=master)](https://github.com/features/actions)
...
[![Go Report Card](https://goreportcard.com/badge/github.com/V2Charge/gin-swagger)](https://goreportcard.com/report/github.com/V2Charge/gin-swagger)
[![GoDoc](https://godoc.org/github.com/V2Charge/gin-swagger?status.svg)](https://godoc.org/github.com/V2Charge/gin-swagger)
[![Release](https://img.shields.io/github/release/swaggo/gin-swagger.svg?style=flat-square)](https://github.com/V2Charge/gin-swagger/releases)
...
4. Download [gin-swagger](https://github.com/V2Charge/gin-swagger) by using:

```sh
go get -u github.com/V2Charge/gin-swagger
...
```go
import "github.com/V2Charge/gin-swagger" // gin-swagger middleware
